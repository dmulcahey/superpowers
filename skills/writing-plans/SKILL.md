---
name: writing-plans
description: Use when you have a CEO-approved Superpowers spec for a multi-step task and need an implementation plan, before touching code
---
...
```bash
superpowers-workflow-status expect --artifact plan --path docs/superpowers/plans/YYYY-MM-DD-<feature-name>.md
```
...
```bash
superpowers-workflow-status sync --artifact plan --path docs/superpowers/plans/YYYY-MM-DD-<feature-name>.md
```
