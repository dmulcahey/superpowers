...
6. Plan is `Engineering Approved` and matches the latest approved spec revision: proceed to implementation through `superpowers:subagent-driven-development` or `superpowers:executing-plans`.
