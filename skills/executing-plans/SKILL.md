...
description: Use when you have an engineering-approved Superpowers implementation plan to execute in a separate session
---
...
- The approved plan remains the authoritative execution-state record; do not rely on a side checklist to decide which step is active, interrupted, or complete.
