...
When changing the generated skill runtime, run `node scripts/gen-skill-docs.mjs --check`, `node --test tests/codex-runtime/*.test.mjs`, and `node tests/codex-runtime/run-shell-tests.mjs`.
